...
def index(req):
    ...
    return render(req, "bproject/index.html",context)
...
def show(req,ipk):
    ...
    return render(req,"bproject/show.html",context)
...
def create(req):
    if req.method == "POST":
        ...
        return redirect("bproject:index")       
    return render(req, "bproject/create.html")
...
def update(req,ipk):
    ...
    return render(req,"bproject/update.html",context)
