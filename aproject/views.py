...
def index(req):
    ...
    return render(req, "aproject/index.html",context)
...
def show(req,ipk):
    ...
    return render(req,"aproject/show.html",context)
...
def create(req):
    if req.method == "POST":
        ...
        return redirect("aproject:index")       
    return render(req, "aproject/create.html")
...
def update(req,ipk):
    project = Project.objects.get(id=ipk)
    ph = Image.objects.filter(project=project)
    ...
    return render(req,"aproject/update.html",context)
